 ...
 */
 ;(function ($) {
  ...
  $.fn.waterwheelCarousel.defaults = {
    ...
    separationMultiplier:       2, // multipled by separation distance to increase/decrease distance for each additional item
    horizonOffset:              0,   // offset each item from the "horizon" by this amount (causes arching)
    horizonOffsetMultiplier:    100,   // multipled by horizon offset to increase/decrease offset for each additional item
...
$(document).ready(function() {
  var carousel = $('.custom-carousel').waterwheelCarousel();

...
(function($){
	...
	SEMICOLON.widget = {
		...
		extras: function(){
			...
			// el.darkLogo.css({'position':'transcom-intro-parallax-relax-element','z-index':'-100'});
			// el.darkRetinaLogo.css({'position':'transcom-intro-parallax-relax-element','z-index':'-100'});
		}
